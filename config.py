...
kwh_rate        = 0.2519  # cost per kilowatt hour per currency_type to calculate cost to run job
kw_elements     = 4.800 # if the kiln elements are on, the wattage in kilowatts
...
emergency_shutoff_temp = 1288 #cone 10
